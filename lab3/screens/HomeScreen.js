      ...
      <View style={styles.container}>
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
          <View style={styles.getStartedContainer}>
           <Text style={styles.getStartedText}>Street Skateboarders</Text>
            <FlatList
             data={[
                   {key: 'painting1',
                    image: require('../assets/images/skate1.jpg'),
                    title:'Skateboarder 1'},
                   {key: 'painting2',
                    image: require('../assets/images/skate2.jpg'),
                    title:'Skateboarder 2'},
                   {key: 'painting3',
                    image: require('../assets/images/skate3.jpg'),
                    title:'Skateboarder 3'}
                  ]}
