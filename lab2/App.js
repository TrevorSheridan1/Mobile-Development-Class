  ...
  render() {
    return (
      ...
      {(this.state.storage == '') ? <View style={styles.container} flexDirection="column" alignItems='stretch'>
              ...
              <View style={styles.container} alignItems="stretch">
                <TextInput style={styles.textInput} value={this.state.value} onChangeText={this.onChange} placeholder="Enter your name">
                </TextInput>{this.state.correctname ? null: <Text className="incorrect" style={styles.defaultText2}>Invalid Name. Please Use Letters ONLY!</Text> }
              </View>
      ...
      <Text className="incorrect" style={styles.defaultText}>Welcome to the site, {this.state.storage}!</Text></View>}
</View>
    );
  }
}
